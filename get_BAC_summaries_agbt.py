...
def main(bam_path, reference_path, output_dir, bac_path):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="FASTA file path of BACs to be compared to ref"
    )
    parser.add_argument(
        "--output_dir",
        type=str,
    ...
    main(bam_path=args.bam, reference_path=args.ref, output_dir=args.output_dir, bac_path=args.bac_ref)
